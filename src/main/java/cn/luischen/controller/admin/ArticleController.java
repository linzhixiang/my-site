...
/**
 * 文章管理 Created by Donghua.Chen on 2018/4/30.
 */
@Api("文章管理")
@Controller
...
public class ArticleController extends BaseController {
	...
	public String index(
		...
		PageInfo<ContentDomain> articles = contentService.getArticlesByCond(
				new ContentCond(), page, limit);
	...
	public APIResponse publishArticle(
		...
		contentDomain.setTags(type.equals(Types.ARTICLE.getType()) ? tags
				: null);
		// 只允许博客文章有分类，防止作品被收入分类
		contentDomain
				.setCategories(type.equals(Types.ARTICLE.getType()) ? categories
						: null);
	...
	public String editArticle(
			@ApiParam(name = "cid", value = "文章编号", required = true) @PathVariable Integer cid,
			HttpServletRequest request) {
	...
	public APIResponse deleteArticle(
		...
		logService.addLog(LogActions.DEL_ARTICLE.getAction(), cid + "",
